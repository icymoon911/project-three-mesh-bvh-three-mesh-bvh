(function (global, factory) {
	...
	class ObjectBVH extends BVH {
		...
		static deserialize( data, objects, options = {} ) {
			...
			const matrixWorld = options.matrixWorld || new three.Matrix4();
		...
		constructor( root, options = {} ) {
			...
			options = {
				...
				matrixWorld: skipGeneration ? new three.Matrix4() : ( Array.isArray( root ) ? new three.Matrix4() : root.matrixWorld ),
				maxLeafSize: 1,
				...options,
			};
